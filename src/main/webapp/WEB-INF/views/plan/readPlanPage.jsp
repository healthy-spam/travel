		    	...
		    	<div class="col" id="route_col">
		    		<div class="row mt-2 align-items-center border p-2 m-1 d-none" id="templete_my_place">
					    ...
					    <div class="col-4 text-center ps-0">
					        <img class="placeImage" alt="" src="" style="width: 130px; height: 90px; border-radius: 15px;">
					    </div>
					    <div class="col-7 p-0">
					        <div class="row">
					            <div class="col">
					                <span class="placeName" style="font-weight: bolder; font-size: 20px;"></span>                            
					            </div>                                                                                
					        </div>
					        <div class="row mt-1">
					            <div class="col">
					                <span class="placeContent" style="display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; color: gray;"></span>
					            </div>
					        </div>
					        <div class="row mt-1">
					            <div class="col">
