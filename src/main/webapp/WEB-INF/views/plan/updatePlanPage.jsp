...
<div class="container">
	...
	<div class="row mt-4">
		<div class="col-4">
			<div class="card">
				<div class="card-header">플래너 수정하기</div>
				<div class="card-body">
				
					<form method="POST" action="./updateContentProcess" enctype="multipart/form-data">
					...
					<!-- <div class="row">
						...
						<div class="form-group">
							<label for="">일정</label> <label for="">+</label>
						</div>
						</div>
					</div>
					<div class="row mt-1">
					...
					<div class="row mt-2">
						...
						<div class="form-group">
                            ...
                            <input type="text" class="form-control" id="plan_title" name="plan_title" value="${data.planDto.plan_title}" required>
						</div>
						</div>
					</div>
					...
					<div class="row mt-2">
						...
						<div class="form-group">
                            ...
                            <input type="text" class="form-control" id="plan_content" name="plan_content" value="${data.planDto.plan_content}" required>
						</div>
						</div>
					</div>
					...
					<input type="hidden" name="plan_id" value="${data.planDto.plan_id}">
					
					<div class="row mt-2">
						<div class="col">						
					<button type="submit" class="d-grid btn btn-dark">수정하기</button>
						</div>
					</div>
					</form>
				</div>
