		...
		<div class="row">
			...
			<div class="col-md-9 offset-md-1">
				...
				<div class="row d-flex justify-content-center mt-5">
					<dl class="row">
					  <dt class="col-sm-2">신고된 가이드</dt>
					  <dd class="col-sm-10">${map.guideUserDto.user_email}
					  </dd>
					  
					  <dt class="col-sm-2">가이드 플랜 번호</dt>
					  <dd class="col-sm-10">${map.guidePlanningDto.guide_planning_id}
					  </dd>
					
					  <dt class="col-sm-2">신고 유형</dt>
					  <dd class="col-sm-10">
					    <p>${map.guideReportDto.guide_report_type}</p>
					  </dd>
					  
					  <dt class="col-sm-2">상세 설명</dt>
					  <dd class="col-sm-10">
					    <p>${map.guideReportDto.guide_report_desc}</p>
					  </dd>
					  
					  <dt class="col-sm-2">첨부 파일</dt>
					  <dd class="col-sm-10">
					    <p>${map.guideReportDto.guide_report_attached}</p>
					  </dd>
					</dl>
				</div>
				<div class="row">
				<form  method="post" action="restrictGuideProcess">
					<div class="mb-3">
					  ...
					  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="guide_restrict_reason"></textarea>
					</div>
					<div class="mb-3">
					  <label for="exampleFormControlTextarea1" class="form-label">제한 방식</label>
					</div>
					<div class="mb-3">
					  <select class="form-select" aria-label="Default select example" name = "guide_report_status">
					  <option value="플랜 생성 제한" selected>플랜 생성 제한</option>
					...
					<div class="mt-3">
						...
						<button type="button" class="btn btn-primary" onclick = "location.href='./guideReportPage'">뒤로가기</button>
					</div>
				</form>
				</div>
				</c:when>
				...
				<c:otherwise>
					<div class="row mt-5">
					<h3>${map.guideUserDto.user_email}님의 제한 상세정보</h3>
				</div>
				<div class="row d-flex justify-content-center mt-5">
					<dl class="row">
					  <dt class="col-sm-2">제한 방식</dt>
					  <dd class="col-sm-10">${map.guideReportDto.guide_report_status}</dd>
					  ...
					  <dd class="col-sm-10">
					    <p><fmt:formatDate value="${map.guideRestrictDto.guide_restrict_start_date}" pattern="yyyy-MM-dd" /></p>
					  </dd>
					  
					  <dt class="col-sm-2">해제 예정일</dt>
					  <dd class="col-sm-10">
					    <p><fmt:formatDate value="${map.guideRestrictDto.guide_restrict_end_date}" pattern="yyyy-MM-dd" /></p>
					  </dd>
					  
						<dt class="col-sm-2">제한 이유</dt>
					  <dd class="col-sm-10">
					    <p>${map.guideRestrictDto.guide_restrict_reason}</p>
					  </dd>
